...
class Pagamento {
    ...
    fun payment(): Screen = Screen(child = Container(children = listOf(
            Text(text =  "Valor do Pagamento").applyStyle(style = style),
            TextInput(value = "").applyStyle(style = style),
            Text(text =  "Código de Barras - BOLETO").applyStyle(style = style),
            TextInput(value = "").applyStyle(style = style),
